...
function PlutusBondHeader({ bond, slippage, recipientAddress, onRecipientAddressChange, onSlippageChange }) {
  ...
  return (
    <div className="bond-header">
      <Link component={NavLink} to="/plutus" className="cancel-bond">
...
export default PlutusBondHeader;
