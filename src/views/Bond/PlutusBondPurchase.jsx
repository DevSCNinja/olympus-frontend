...
import { shorten, trim, secondsUntilBlock, prettifySeconds, plutusBondInfo } from "../../helpers";
...
function PlutusBondPurchase({ bond, slippage }) {
        ...
        <Box className="bond-data">
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {trim(bondQuote, 4) || ""} {bondInfo.payoutTokenTicker}
            </Typography>
          </div>
          ...
          <div className={`data-row`}>
            ...
            <Typography id="bond-value-id" className="price-data">
              {trim(maxBondPrice, 4) || ""} {bondInfo.payoutTokenTicker}
            </Typography>
          </div>
...
export default PlutusBondPurchase;
